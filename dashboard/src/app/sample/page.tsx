...
export default function SampleReviewPage() {
  ...
  return <main className="sample-page">
    <header className="sample-nav"><BrandMark /><div><span>Free public demo</span><Link className="button" href="/signin?callbackUrl=%2F">Sign in<ArrowRight size={15} /></Link></div></header>
